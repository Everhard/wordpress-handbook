...
class My_Awesome_Plugin_Admin {
	...
	public function add_admin_menu_items() {
		...
		add_menu_page(
			...
			'manage_options',
			'my-awesome-plugin',
			[ $this, 'show_admin_dashboard_page' ],
		...
		add_submenu_page(
			...
			[ $this, 'show_admin_information_page' ]
		);
	}
	...
	public function show_admin_dashboard_page() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'partials/my-awesome-plugin-admin-dashboard.php';
	}

	/**
	 * Show the admin information page.
	 *
	 * @since    1.0.0
	 * @return void
	 */
	public function show_admin_information_page() {

		require_once plugin_dir_path( __FILE__ ) . 'partials/my-awesome-plugin-admin-information.php';
	}
